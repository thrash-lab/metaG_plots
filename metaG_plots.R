...
ggsave("SFBay_map_RPKM_by_genome.pdf", dpi = 300, width = 11, height = 8.5)
...
ggsave("genomes_by_rpkm_barplot_SFBay.pdf", dpi = 300, width = 11, height = 8.5)
...
ggsave("genomes_by_rpkm_boxplot_SFBay.pdf", dpi = 300, width = 11, height = 8.5)
